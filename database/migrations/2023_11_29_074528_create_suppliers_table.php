...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('suppliers', function (Blueprint $table) {
            ...
            $table->string('entreprise_name_sup', 255)->default('-');
            $table->string('rccm_sup', 255)->default('-');
            $table->string('id_nat_sup', 255)->default('-');
            $table->string('nif_sup', 255)->default('-');
            $table->string('account_num_sup', 255)->default('-');
            $table->string('website_sup', 255)->default('-');
