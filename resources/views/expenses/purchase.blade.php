@extends('base')
@section('title', __('dashboard.purchases'))
@section('content')
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>{{ __('dashboard.purchases') }}</h3>
                        <p class="text-subtitle text-muted">{{ __('expenses.purchases_list') }}</p>
                    </div>
