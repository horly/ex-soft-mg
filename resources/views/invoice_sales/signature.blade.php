@extends('base')
@section('title', __('invoice.your_signature'))
@section('content')
                            ...
                            <div class="col-md-6">
                                <div class="card border">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <span>{{ __('invoice.your_signature') }}</span>
                                        <span>
                                            <button class="btn btn-primary" data-bs-toggle="modal" onclick="add_sign_seal('{{ __('invoice.your_signature') }}')" data-bs-target="#edit-photo">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img src="{{ asset('assets/img/invoice/signature/SIGN_') }}{{ Auth::user()->signature_id }}.jpg" width="350" alt="" class="border img-fluid">
