                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="number" step="0.01" class="form-control text-end @error('unit_price_art') is-invalid @enderror" id="unit_price_art" name="unit_price_art" placeholder="{{ __('article.enter_the_article_unit_price') }}" value="{{ number_format($article->unit_price, 2, '.', ' ') }}">
