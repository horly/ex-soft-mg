            ...
            <div class="row">
                ...
                @if($customer_assign || Auth::user()->role->name == "admin" || Auth::user()->role->name == "superadmin")
                    <div class="col-6 col-lg-3 col-md-6">
                        <div class="card">
                            <a href="{{ route('app_customer', ['group' => 'customer', 'id' => $entreprise->id, 'id2' => $functionalUnit->id]) }}" class="card-body px-3 py-4-5 link-dashboard-widget">
                                <div class="row">
                                    <div class="col-md-4">
                ...
                @if($stock_assign || Auth::user()->role->name == "admin" || Auth::user()->role->name == "superadmin")
                    <div class="col-6 col-lg-3 col-md-6">
                        <div class="card">
                            <a href="{{ route('app_article', ['group' => 'stock', 'id' => $entreprise->id, 'id2' => $functionalUnit->id]) }}" class="card-body px-3 py-4-5 link-dashboard-widget">
                                <div class="row">
                                    <div class="col-md-4">
                ...
                @if($sale_assign || Auth::user()->role->name == "admin" || Auth::user()->role->name == "superadmin")
                    <div class="col-6 col-lg-3 col-md-6">
                        <div class="card">
                            <a href="{{ route('app_sales_invoice', ['group' => 'sale', 'id' => $entreprise->id, 'id2' => $functionalUnit->id]) }}" class="card-body px-3 py-4-5 link-dashboard-widget">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0" id="recettes-global">
                                            {{ $recettes }} {{ $deviseGest->iso_code }}
                                        </h6>
                                    </div>
                                </div>
                            </a>
                ...
                @if($expense_assign || Auth::user()->role->name == "admin" || Auth::user()->role->name == "superadmin")
                    <div class="col-6 col-lg-3 col-md-6">
                        <div class="card">
                            <a href="{{ route('app_purchases', ['group' => 'expense', 'id' => $entreprise->id, 'id2' => $functionalUnit->id]) }}" class="card-body px-3 py-4-5 link-dashboard-widget">
                                <div class="row">
                                    <div class="col-md-4">
